...
export const Faq: React.FC = () => {
    return (
        <div className="p-8 ">
            ...
            <h2 className="text-2xl font-semibold mt-2 mb-4">Got a question about our course?</h2>
            ...
            <div className="space-y-2">
                {[...Array(5)].map((_) => (
                    <Accordion type="single" collapsible className="bg-white rounded-lg shadow-xl  p-1">
            ...
            <Card className="mt-6 bg-white">
                <CardContent className="p-6">
                    <div className="flex ">
                        <div className="lg:w-1/2 pr-4 flex flex-col justify-around">
                            <div>
                                <h3 className="text-xl font-semibold mb-2">Got another question?</h3>
